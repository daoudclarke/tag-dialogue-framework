 ...
 * Time: 11:45
 */
public class FilmCollection extends RecordBasedXMLCollection {

    private Merchant merchant;

    public FilmCollection(File xmlFile, Merchant merchant) throws FileNotFoundException, UnsupportedEncodingException, XMLStreamException {
    ...
    private class Record {
        ...
        public Product toProduct(){
            ...
            p.setTags(Lists.newArrayList("film"));
