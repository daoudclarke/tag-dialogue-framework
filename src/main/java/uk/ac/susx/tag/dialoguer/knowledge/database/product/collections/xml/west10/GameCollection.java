 ...
 * Time: 16:12
 */
public class GameCollection extends RecordBasedXMLCollection {

    private Merchant merchant;

    public GameCollection(File xmlFile, Merchant merchant) throws FileNotFoundException, UnsupportedEncodingException, XMLStreamException {
    ...
    private class Record {
        ...
        private List<RecordBasedXMLCollection.BasicRecord> contributorList;
        private List<RecordBasedXMLCollection.BasicRecord> trackList;
        ...
        public Product toProduct(){
            ...
            Set<String> propertyExcludes = Sets.newHashSet("authTitle", "facet", "imprintExact",
                    ...
                    "extras2", "extras1", "extras_tbc", "psc", "psg");
            ...
            if(contributorList!=null){
                for (RecordBasedXMLCollection.BasicRecord r : contributorList){
                    p.addPropertyValue("contributor"+r.getAtts().get("role"), r.getAtts().get("person_display_name"));
                }
            }

            if (trackList!=null){
                for (RecordBasedXMLCollection.BasicRecord r : trackList){
                    p.addPropertyValue("track", r.getAtts().get("track_name"));
                }
            }

            p.setTags(Lists.newArrayList("game"));
            ...
            p.setMainProps(Lists.newArrayList("title","format", "edition"));
